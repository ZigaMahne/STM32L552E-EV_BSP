...
/*! \page vio_STM32L552E-EV Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | Wakeup button (B2)   | PC13
| vioLED0       | vioSignalOut.0 | LED red       (LD5)  | PD3
| vioLED1       | vioSignalOut.1 | LED green     (LD4)  | PB3
*/
...
//  signal,     pin,                   pull resistor,      active state
  ...
  { vioLED1,    GPIO_PIN_ID_PORTB(3),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
